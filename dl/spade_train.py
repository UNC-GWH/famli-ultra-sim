...
def main(args):
    ...
    if args.freeze_usr:
        model.USR.eval()
    train_transform = LotusTrainTransforms(height=args.height)
    valid_transform = LotusEvalTransforms(height=args.height)
    ...
    train_transform_b = RealUSTrainTransformsV2(height=args.height)
    valid_transform_b = RealUSEvalTransformsV2(height=args.height)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='SPADE training')
    ...
    # hparams_group.add_argument('--grid_w', help='Grid size for the simulation', type=int, default=128)
    # hparams_group.add_argument('--grid_h', help='Grid size for the simulation', type=int, default=128)
    # hparams_group.add_argument('--center_x', help='Position of the circle that creates the transducer', type=float, default=64.0)
    # hparams_group.add_argument('--center_y', help='Position of the circle that creates the transducer', type=float, default=-15.0)
    # hparams_group.add_argument('--r1', help='Radius of first circle', type=float, default=10.0)
    # hparams_group.add_argument('--r2', help='Radius of second circle', type=float, default=107.0)
    ...
    # hparams_group.add_argument('--center_y_start', help='Start of center_y', type=float, default=-20.0)
    # hparams_group.add_argument('--center_y_end', help='Delta of center_y', type=float, default=-10.0)    
    # hparams_group.add_argument('--r2_start', help='Start of radius r1', type=float, default=100.0)
    # hparams_group.add_argument('--r2_end', help='Delta of radius r1', type=float, default=108)
    ...
    hparams_group.add_argument('--height', help='Shape of the input image', type=int, default=256)
    ...
    hparams_group.add_argument('--theta_start', help='Aperture angle of transducer', type=float, default=np.pi/6.0)
    hparams_group.add_argument('--theta_end', help='Aperture angle of transducer delta', type=float, default=np.pi/4.0)
    hparams_group.add_argument('--freeze_usr', help='Freeze the US renderer', type=int, default=0)
    ...
    hparams_group.add_argument('--perceptual_weight', help='Perceptual weight', type=float, default=1e-3)
    hparams_group.add_argument('--adversarial_weight', help='Adversarial weight', type=float, default=1e-2)
    hparams_group.add_argument('--kl_weight', help='KL weight', type=float, default=1e-6)
    hparams_group.add_argument('--nce_weight', help='NCE weight', type=float, default=1.0)
    hparams_group.add_argument('--sim_weight', help='Cosine similarity weight', type=float, default=1.0)    
    hparams_group.add_argument('--recons_weight', help='KL weight', type=float, default=1.0)
    hparams_group.add_argument('--feature_weight', help='feature_weight for multiscale GAN', type=float, default=0.1)
    hparams_group.add_argument('--warm_up_epochs', help='Number of warm up epochs before starting to train with discriminator', type=int, default=0)
    ...
    log_group.add_argument('--logger', help='Neptune tags', type=str, default="SPADELogger")
