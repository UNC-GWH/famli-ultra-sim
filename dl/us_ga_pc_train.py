...
from loaders.ultrasound_dataset import USDataModuleBlindSweepWTag
...
def main(args):
    ...
    data_module = USDataModuleBlindSweepWTag(df_train, df_val, df_test, mount_point=args.mount_point, batch_size=args.batch_size, img_column='file_path', ga_column='ga_boe', id_column='study_id', max_sweeps=3, drop_last=True)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='US PC GA training')
